...
$(window).load(function(){
	...
	// 將menuNum3 HighLight
	$("#menuNum3").addClass("active");
});

// 由於submit後，其他參數會消失，故用此方法保留參數
function search(){
	document.location.href = "productList1.php?displayNum=<?php echo $displayNum;?>"
				...
				<div class="col-lg-4">
					<?php if($dataTotal==0) echo "查無資料";
						  ...
						  if($searchFor1!="" || $searchFor2!="" || $searchFor3!="")
							echo "<br><a href=\"productList1.php?displayNum=".$displayNum."\">返回查看所有財產</a>";
					?>
				</div>
				<div class="col-lg-12">
					...
					<table class="table table-hover table-bordered">
						<thead>
							<tr class="info">
								...
								<th style="min-width:200px;">財產名稱<br>財產別名</th>
						...
						<tbody>
							...
							<tr>
								<td><?php if($recordArray[$i]['照片'])
											echo "<img src=\"show_photo.php?pro_list=1&pro_mainID=".$recordArray[$i]['財產編號']."&pro_subID=".$recordArray[$i]['財產序號']."\" _w='300'>";
										  else echo '暫無照片'; ?>
								</td>
								<td><a href="<?php echo "productList1.php?displayNum=".$displayNum."&searchFor1=".$recordArray[$i]['財產編號'];?>"><?php echo $recordArray[$i]['財產編號'];?></a><br><?php echo $recordArray[$i]['財產序號'];?></td>
								<td><?php echo $recordArray[$i]['財產名稱']."<br>".$recordArray[$i]['財產別名']; ?></td>
								...
								<td><button type="button" class="btn btn-success" 
									onclick="window.open('<?php echo "productState.php?pro_list=1&pro_mainID=".$recordArray[$i]['財產編號']."&pro_subID=".$recordArray[$i]['財產序號']; ?>')">預約</button>
								</td>
							</tr>
							<?php } ?>
						</tbody>
